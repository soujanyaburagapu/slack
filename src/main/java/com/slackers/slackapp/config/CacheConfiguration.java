package com.slackers.slackapp.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("Slack_Jhip");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("Slack_Jhip");
        ...
        config.getMapConfigs().put("com.slackers.slackapp.domain.*", initializeDomainMapConfig(jHipsterProperties));
